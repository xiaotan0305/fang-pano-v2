...
function createHUDSprites(texture) {
    ...
    // var fullScreenTexture = textureLoader.load("textures/fullScreen.png");
    ...
    textureLoader.load("textures/button_Auto.png");
    textureLoader.load("textures/button_2D_pressed.png");
    textureLoader.load("textures/button_3D_pressed.png");
    var switchAutoButtonTexture = textureLoader.load("textures/button_Auto_pressed.png");
    ...
    var switch2DButtonTexture = textureLoader.load("textures/button_2D.png");
    ...
    var switch3DButtonTexture = textureLoader.load("textures/button_3D.png");
    ...
    var sectorTexture = textureLoader.load("textures/sector.png");
    ...
    var hotSpotTexture = textureLoader.load("textures/hotSpotPoint.png");
    ...
    var bgTexture = textureLoader.load("textures/bg.png", function () {
...
function initPanoramaView() {
    ...
    var logoSize = 300;
    var texture = textureLoader.load('textures/logo.png');
...
function createHotSpots() {
    var texture = textureLoader.load('textures/hotspot/feet.png');
    var spriteTexture = textureLoader.load( "textures/hotspot_sprite.png");
    ...
    var lightTexture = textureLoader.load('textures/hotspot/light.png');
...
function onSwitch2DButtonClicked() {
    setAutoMode(false);
    switchToMap(true);
    switch2DButton.material.map = textureLoader.load("textures/button_2D_pressed.png");
    switch3DButton.material.map = textureLoader.load("textures/button_3D.png");
}

function onSwitch3DButtonClicked() {
    setAutoMode(false);
    switchToMap(false);
    switch2DButton.material.map = textureLoader.load("textures/button_2D.png");
    switch3DButton.material.map = textureLoader.load("textures/button_3D_pressed.png");
}
...
function setAutoMode(needAutoMode) {
    if (needAutoMode) {
        switchAutoButton.material.map = textureLoader.load("textures/button_Auto_pressed.png");
        starAutoPlayDelay();
        ...
        switchAutoButton.material.map = textureLoader.load("textures/button_Auto.png");
    }
}
